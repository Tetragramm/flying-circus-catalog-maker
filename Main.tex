...
\FCPlaybook[Name={A Worker}, SubHeader={INdustrial Town}]{
    ...
    \begin{center}
        {\centering Choose, and add +1 to a stat.}
    \end{center}
    ...
    \begin{NiceTabular}[rules/width=0.5mm]{XXXX X XXXX}
        ...
        \Block{1-4}{\centering Just punching the clock.}               &
                                                                       ...
                                                                       &
        \\
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Hard}}   &
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Keen}}   &
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Calm}}   &
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Daring}} &
                                                                       &
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Hard}}   &
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Keen}}   &
        \Block[color=black,fill=black]{1-1}{\textcolor{white}{Calm}}   &
    ...
    \begin{tikzpicture}[overlay]
        \node [draw=black, thick, circle, minimum size=5mm, xshift=3mm, yshift=-24mm] (a) {};
